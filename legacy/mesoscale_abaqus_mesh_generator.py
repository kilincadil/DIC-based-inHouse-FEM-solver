...
This data is then used to assign material properties to the respective mesh elements.  The 2D mesh is generated using CRISTALX, a tool developed by Zoltán Csati for creating 
